      ...
      {productsFromServer.map((productFromServer, index) => {
        ...
        return (
          <div
            ...
            className="flex justify-between gap-16 max-lg:flex-col max-sm:items-center"
          >
                ...
                <div className="flex justify-between">
                  ...
                  <div className="flex gap-4 cursor-pointer">
                    ...
                    <i
                      ...
                      onClick={() => handleRemoveProduct(productFromServer._id)}
                    ></i>
                  </div>
                </div>
            ...
            <div className="flex flex-col justify-between max-lg:gap-8">
              <div className="flex justify-between gap-44">
                ...
                <p className="font-palanquin font-thin text-lg text-gray-600">
                  $
                  {(productFromServer.price * cartProduct?.quantity).toFixed(2)}
                </p>
              </div>
              <div className="flex justify-between gap-44">
                <p className="font-palanquin font-thin text-lg text-gray-600">
